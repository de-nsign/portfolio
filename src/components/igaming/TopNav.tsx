...
export default function TopNav() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-bg">
      <nav className="relative mx-auto flex max-w-[1056px] items-center justify-between px-6 py-5 text-[16px] text-ink">
        ...
        <div className="pointer-events-none absolute left-1/2 hidden -translate-x-1/2 text-[16px] md:block">
          ヴラド
        </div>
